...
[프로젝트 개요](#-프로젝트-개요) • [핵심 기능](#-핵심-기능) • [문제 해결](#-담당-및-문제-해결) • [시스템 구성](#-시스템-구성) • [검증 범위](#-구현-결과와-검증-범위)
...
**이정운 — HW·SW 통합 및 실물 트러블슈팅**

- ESP32·BLE·서보모터·Web 연동
- CATIA/3D 프린팅 기구물 조립 편차 보정
- 손 제스처 인식 환경 개선
- 복약 시뮬레이션 및 장치 상태 확인 구조 구성
